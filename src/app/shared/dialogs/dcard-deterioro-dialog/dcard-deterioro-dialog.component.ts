...
@Component({
  selector: "dcard-deterioro-dialog",
  templateUrl: "dcard-deterioro-dialog.component.html",
  providers: [AfiliadosService],
})
export class DcardDeterioroDialogComponent {
  public title: string;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DcardDeterioroDialogComponent>,
